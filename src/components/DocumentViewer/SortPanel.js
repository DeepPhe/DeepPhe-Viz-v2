    ...
    <GridContainer xs={12} style={{ display: "flex", height: "100%" }}>
      <GridItem xs={4}>
        ...
        <Menu id="demo-customized-menu" anchorEl={anchorEl} open={open} onClose={handleClose}>
          <MenuItem onClick={() => handleSortChange("Alphabetically")}>Alphabetically</MenuItem>
          <Divider sx={{ background: "black", borderBottomWidth: 2 }} />
          <MenuItem onClick={() => handleSortChange("Semantic Group")}>Semantic Group</MenuItem>
          <Divider sx={{ background: "black", borderBottomWidth: 2 }} />
          <MenuItem onClick={() => handleSortChange("Confidence")}>Confidence</MenuItem>
        </Menu>
      </GridItem>
